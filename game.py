...
class Cactus:
        ...
        def update(self):
                ...
                global score
                if score < 50:
                        tela.blit(pygame.image.load(os.path.join("images/bg1.png")), (0, 0))
                elif 50 < score < 100:
                        tela.blit(pygame.image.load(os.path.join("images/bg2.png")), (0, 0))
                        self.sprite_y = 32
                else:
                        tela.blit(pygame.image.load(os.path.join("images/bg3.png")), (0, 0))
                        self.sprite_y = 64
